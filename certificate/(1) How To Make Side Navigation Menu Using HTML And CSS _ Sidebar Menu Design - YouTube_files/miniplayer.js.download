(function(g){var window=this;'use strict';var Xhb=function(a,b){g.W.call(this,{G:"button",La:["ytp-miniplayer-expand-watch-page-button","ytp-button","ytp-miniplayer-button-top-left"],Y:{title:"{{title}}","data-tooltip-target-id":"ytp-miniplayer-expand-watch-page-button","aria-keyshortcuts":"i","data-title-no-tooltip":"{{data-title-no-tooltip}}"},X:[{G:"svg",Y:{height:"24px",version:"1.1",viewBox:"0 0 24 24",width:"24px"},X:[{G:"g",Y:{fill:"none","fill-rule":"evenodd",stroke:"none","stroke-width":"1"},X:[{G:"g",Y:{transform:"translate(12.000000, 12.000000) scale(-1, 1) translate(-12.000000, -12.000000) "},
X:[{G:"path",Y:{d:"M19,19 L5,19 L5,5 L12,5 L12,3 L5,3 C3.89,3 3,3.9 3,5 L3,19 C3,20.1 3.89,21 5,21 L19,21 C20.1,21 21,20.1 21,19 L21,12 L19,12 L19,19 Z M14,3 L14,5 L17.59,5 L7.76,14.83 L9.17,16.24 L19,6.41 L19,10 L21,10 L21,3 L14,3 Z",fill:"#fff","fill-rule":"nonzero"}}]}]}]}]});this.I=a;this.Ta("click",this.onClick,this);this.updateValue("title",g.qT(a,"Expand","i"));this.update({"data-title-no-tooltip":"Expand"});g.ob(this,g.kT(b.Ec(),this.element))},Yhb=function(a){g.W.call(this,{G:"div",
S:"ytp-miniplayer-ui"});this.rg=!1;this.player=a;this.T(a,"minimized",this.Zh);this.T(a,"onStateChange",this.NP)},Zhb=function(a){g.$T.call(this,a);
this.u=new g.$J(this);this.j=new Yhb(this.player);this.j.hide();g.ZS(this.player,this.j.element,4);a.Vf()&&(this.load(),g.sq(a.getRootNode(),"ytp-player-minimized",!0))};
g.x(Xhb,g.W);Xhb.prototype.onClick=function(){this.I.Qa("onExpandMiniplayer")};g.x(Yhb,g.W);g.k=Yhb.prototype;
g.k.OM=function(){this.tooltip=new g.vW(this.player,this);g.I(this,this.tooltip);g.ZS(this.player,this.tooltip.element,4);this.tooltip.scale=.6;this.Vc=new g.CU(this.player);g.I(this,this.Vc);this.Yj=new g.W({G:"div",S:"ytp-miniplayer-scrim"});g.I(this,this.Yj);this.Yj.Ha(this.element);this.T(this.Yj.element,"click",this.sH);var a=new g.W({G:"button",La:["ytp-miniplayer-close-button","ytp-button"],Y:{"aria-label":"Close"},X:[g.iR()]});g.I(this,a);a.Ha(this.Yj.element);this.T(a.element,"click",this.kp);
a=new Xhb(this.player,this);g.I(this,a);a.Ha(this.Yj.element);this.Tu=new g.W({G:"div",S:"ytp-miniplayer-controls"});g.I(this,this.Tu);this.Tu.Ha(this.Yj.element);this.T(this.Tu.element,"click",this.sH);var b=new g.W({G:"div",S:"ytp-miniplayer-button-container"});g.I(this,b);b.Ha(this.Tu.element);a=new g.W({G:"div",S:"ytp-miniplayer-play-button-container"});g.I(this,a);a.Ha(this.Tu.element);var c=new g.W({G:"div",S:"ytp-miniplayer-button-container"});g.I(this,c);c.Ha(this.Tu.element);this.oX=new g.HV(this.player,
...
La:["ytp-miniplayer-close-button","ytp-button"],Y:{"aria-label":"Close"},X:[g.iR()]});g.I(this,a);a.Ha(this.cH.element);this.T(a.element,"click",this.kp);a=new g.W({G:"button",La:["ytp-miniplayer-replay-button","ytp-button"],Y:{"aria-label":"Close"},X:[g.rDa()]});g.I(this,a);a.Ha(this.cH.element);this.T(a.element,"click",this.l7);this.T(this.player,"presentingplayerstatechange",this.Id);this.T(this.player,"appresize",this.Hb);this.T(this.player,"fullscreentoggled",this.Hb);this.Hb()};
...
g.k.YA=function(){};
g.k.ys=function(){};
g.k.JD=function(){};g.x(Zhb,g.$T);g.k=Zhb.prototype;g.k.onVideoDataChange=function(){if(this.player.getVideoData()){var a=this.player.getVideoAspectRatio(),b=16/9;a=a>b+.1||a<b-.1;g.sq(this.player.getRootNode(),"ytp-rounded-miniplayer-not-regular-wide-video",a)}};
...
g.k.unload=function(){this.player.showControls();this.j.hide()};g.ZT("miniplayer",Zhb);})(_yt_player);
